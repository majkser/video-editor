...
class MediaProcessingProvider(BaseProvider):
    ...
    def get_service(
        ...
        MediaProcessingProvider.UPLOAD_DIR.mkdir(parents=True, exist_ok=True)
        return MediaProcessingImpl(
            server_root=MediaProcessingProvider.SERVER_ROOT,
            upload_dir=MediaProcessingProvider.UPLOAD_DIR,
